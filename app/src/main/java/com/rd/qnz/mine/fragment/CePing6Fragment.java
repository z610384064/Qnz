...
public class CePing6Fragment extends Fragment implements View.OnClickListener {
    private Context context;
    private LinearLayout rl1,rl2,rl3,rl4;
    private ImageView  iv_select1,iv_select2,iv_select3,iv_select4;
    private TextView tv_last;
    public CePing6Fragment(){}
    public CePing6Fragment(Context context){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=View.inflate(context, R.layout.fragment_ceping6,null);
