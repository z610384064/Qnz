...
public class JiaXiH5Fragment extends Fragment {
    ...
    public JiaXiH5Fragment(Context context){
        this.context=context;
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=View.inflate(context, R.layout.jiaxi_h5,null);
    ...
    private String getRechargeBalanceResultUrl() {
        ...
        String[] array = new String[]{
                ...
                BaseParam.URL_QIAN_API_SERVICE + "=" + "couponH5",
        ...
        strBuffer.append(BaseParam.URL_QIAN_MY_H5_JIAXI);
        strBuffer.append("?");
