...
public class CePing2Fragment extends Fragment implements View.OnClickListener {
    private Context context;
    private LinearLayout rl1,rl2,rl3,rl4;
    private ImageView  iv_select1,iv_select2,iv_select3,iv_select4;
    private TextView tv_last;
    public CePing2Fragment(){}
    public CePing2Fragment(Context context){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=View.inflate(context, R.layout.fragment_ceping2,null);
