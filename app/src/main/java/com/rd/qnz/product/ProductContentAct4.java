 ...
 * @author Evonne
 */
public class ProductContentAct4 extends AppCompatActivity implements OnClickListener {
...
//						mToast = Toast.makeText(BaseActivity.this, text, Toast.LENGTH_SHORT);
                        mToast = new Toast(ProductContentAct4.this);
                        View tview = LayoutInflater.from(ProductContentAct4.this).inflate(R.layout.layout_toast, null);
...
//					mToast = Toast.makeText(BaseActivity.this, resId, Toast.LENGTH_SHORT);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.homepage_product_list_content4);
    ...
    private void initBar() {
        ...
        actionbar_side_share.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                SharePopupWindow.start(ProductContentAct4.this, true, "2", "","钱内助");
            }
        });
...
//    }
    ...
    public static void start(Context context, String borrowId) {
        ...
        Intent i = new Intent(context, ProductContentAct4.class);
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message paramMessage) {
            ...
            if (null != progressDialog && progressDialog.isShowing()) {// 隐藏加载框
                ProductContentAct4.this.progressDialog.dismiss();
            }
            if (null != product_R) {
                ...
                if (resultCode.equals("1")) {
                    ...
                    if (TextUtils.equals(map.get(BaseParam.QIAN_PRODUCT_BR_TYPE), "3")) {
                        productLimitTime = ProductContentAct4.this.getString(R.string.product_list_apr_baobao_format);
...
//                        touziHistoryFragment=new com.rd.qnz.product.fragment3.TouziHistoryFragment(ProductContentAct3.this,viewpager); //投资记录
                    ...
                    if (productStatus.equals("1")) {//1：申购
                        ...
                        if (Integer.valueOf(countDownTime) > 0) {
                            ...
                            product_tender_btn.setVisibility(View.GONE);
                            countDown.setVisibility(View.GONE);
                            progressDialog = dia.getLoginDialog(ProductContentAct4.this, "刷新中，请稍后..");
                            progressDialog.show();
                        ...
                        if (map.get("errorCode").equals("TOKEN_NOT_EXIST")) {
                            startActivity(new Intent(ProductContentAct4.this, Login.class));
    ...
    private void startDataRequest() {
        ...
        if (Check.hasInternet(ProductContentAct4.this)) {
            ProductContentAct4.this.initArray();
            ProductContentAct4.this.param.add(BaseParam.QIAN_PRODUCT_BORROWID);
            ProductContentAct4.this.value.add(borrowId);

            ProductContentAct4.this.param.add(BaseParam.URL_QIAN_API_APPID);
            ProductContentAct4.this.value.add(myApp.appId);
            ProductContentAct4.this.param.add(BaseParam.URL_QIAN_API_SERVICE);
            ProductContentAct4.this.value.add("productDetail");
            ProductContentAct4.this.param.add(BaseParam.URL_QIAN_API_SIGNTYPE);
            ProductContentAct4.this.value.add(myApp.signType);
            ...
            ProductContentAct4.this.param.add(BaseParam.URL_QIAN_API_SIGN);
            ProductContentAct4.this.value.add(sign);
            ProductContentAct4.this.progressDialog = ProductContentAct4.this.dia.getLoginDialog(ProductContentAct4.this, "正在获取数据..");
            progressDialog.setCancelable(true);
            ProductContentAct4.this.progressDialog.show();
            new Thread(new JsonRequeatThreadProductContent(
                    ProductContentAct4.this,
                    myApp,
                    ProductContentAct4.this.myHandler,
                    ProductContentAct4.this.param,
                    ProductContentAct4.this.value)
            ).start();
        } else {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
                ...
                if (MineShow.fastClick()) {
                    if (mAuthoToken.equals("") || mAuthoToken == null) {//未登录
                        ...
                        if (realStatus.equals("0") || realStatus == null) {//未实名认证
                            startActivity(new Intent(ProductContentAct4.this, NewRealAct.class));
                            return;
                        }
                    }
                    ...
                    if (TextUtils.equals(Profile.getUserPayPassWordStatus(), "0")) {//未设置交易密码
                        Intent intent = new Intent(ProductContentAct4.this, ForgetPasswordAct.class);
            ...
            case R.id.repayment:
                if (MineShow.fastClick()) {
                    Intent repayment = new Intent(ProductContentAct4.this, LastRepayTimeActivity.class);
            ...
            case R.id.relativeLayout2:  //点击了额外奖励
                if (MineShow.fastClick()) {
                    Intent intent = new Intent(ProductContentAct4.this, WebViewAct.class);
