 ...
 * associated request.
 */
public class RoundCornerNetworkImageView extends ImageView {
     ...
     * {@link RoundCornerNetworkImageView#setDefaultImageResId(int)} on the view.
     *
     * NOTE: If applicable, {@link RoundCornerNetworkImageView#setDefaultImageResId(int)} and
     * {@link RoundCornerNetworkImageView#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if ( !mCircled && getDrawable() != null) {
            ...
            try {
                ...
                if(bitmap != null){
                    Bitmap circleBitmap = getRoundCornerBitmap(bitmap);
