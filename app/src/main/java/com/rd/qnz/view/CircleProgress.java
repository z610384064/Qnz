...
/**
 * Created by Evonne on 2016/12/13.
 */
public class CircleProgress extends View {
    ...
    private int socktwidth = dp2px(3);// 圆环进度条的宽度
    ...
    private int preColor = Color.parseColor("#f1eff0");// 进度条未完成的颜色
    private int progressColor = Color.parseColor("#fd6721");// 进度条颜色
    private float paddingscale = 0.9f;// 控件内偏距占空间本身的比例
    private int CircleColor = Color.parseColor("#ffe4d7");// 圆中间的背景颜色
    private int CircleColor2 = Color.parseColor("#ffffff");// 圆中间的背景颜色
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(width / 2, height / 2, radius - socktwidth - 5, paint);
     ...
     * @param value
     */
    public CircleProgress setTextwen(String value) {
        this.text = value;
        return this;
    }
