...
import com.rd.qnz.xutils.XutilsConfig;
...
public class BitmapUtils implements TaskHandler {
    ...
    public static BitmapUtils getInstence(){
    	if(mInstance == null ){
    		XutilsConfig.PATH_CACHE = XutilsConfig.PATH_BASE +"cache" + File.separator;//文件缓存路径
    		mInstance = new BitmapUtils(MyApplication.getInstance().getApplicationContext());
    	}
    	return mInstance;
    }
    ...
    public BitmapUtils(Context context) {
        this(context, XutilsConfig.PATH_CACHE);
    }
